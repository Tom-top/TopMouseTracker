...
ax0.legend(handles=[nesting, seeds, major], labels=["Nesting Bouts",
                                                    "Start of nesting event",
                                                    "Start of major nesting event"],
           loc=2)
...
patch = patches.Rectangle((0, min(Mean)),
                          width=np.mean(majorEventsLengths)*12000,
                          height=(max(Mean)-min(Mean))*0.1,
