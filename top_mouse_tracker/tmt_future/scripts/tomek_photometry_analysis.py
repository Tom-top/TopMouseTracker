...
def LivePhotometryTrack(vidClip, x, yData, thresh, globalAcceleration=1, plotAcceleration=SRD, showHeight=True, showTrace=True):
...
#                calciumGraph.set_data(x[0:i], y2[0:i])
                ...
                pass  # FIXME: bad exception handling
...
LivePhotometryTrack(videoClipCropped, rawX, yData, displayThreshold, globalAcceleration=5, plotAcceleration=SRD)
