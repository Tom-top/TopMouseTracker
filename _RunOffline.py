...
params.mainParameters["mouse"] = "285";
...
params.mainParameters["workingStation"] = "Pink Floyd";
params.mainParameters["tmtDir"] = "/mnt/raid/TopMouseTracker";
params.mainParameters["dataDir"] = os.path.join(params.mainParameters["tmtDir"],"190510");
params.mainParameters["workingDir"] = [ os.path.join(params.mainParameters["dataDir"],'10-5-2019_9-14-36') ];
...
Tracker.AdjustThresholdingCotton(params.mainParameters["capturesRGB"][0], 300);
